                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group-dark">
                                            ...
                                            <input type="text" name="contact_email" class="form-control required" placeholder="Email" value={contactDetails.contact_email} onChange={(e)=>onTodoChange(e)} /></div></div>
                                    <div class="col-lg-12">
                                        <div class="form-group-dark">
                                            <label>Subject</label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group-dark">
                                            <label>Message</label><textarea name="contact_message" onChange={(e)=>onTodoChange(e)} value={contactDetails.contact_message} class="form-control required"/></div></div>

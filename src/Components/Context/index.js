...
export const DataProvider = ({ children }) => {
    ...
    let existingUserSessionString = localStorage.getItem('USER_SESSION');
    let existingUserSession=existingUserSessionString?JSON.parse(existingUserSessionString):''
    // console.log(existingUserSession)



    return (
        <DataContext.Provider value={{ cartCount, setcartCount, cartsummary, setcartsummary, rerenderdata ,existingUserSession}}>
            {children}
